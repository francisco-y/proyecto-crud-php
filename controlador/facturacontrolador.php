...
class FacturaController{
    ...
    public function __construct(){
        ...
        $this->modelo = new facturaModel($conexion); //Pasar la conexion al modelo
    }
    public function manejarSolicitud(){
        if(isset($_POST['accion'])){
            if($_POST['accion'] == 'guardar'){
                ...
                $clienteid = $_POST['codigocli'];
                $user = '1';
                $this->modelo->insertarFactura($id, $fecha, $condicion, $estado, $clienteid, $user);
