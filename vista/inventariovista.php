...
if(!isset($_SESSION['usuario_iniciado']) || $_SESSION['usuario_iniciado'] !== "activo"){
    ...
    $inventarios = $controllerinv->obtenerProductos();
}
    ...
    <main class="content">
        ...
        <table border="1" id="ta-ciu">
            ...
            <?php foreach ($inventarios as $inventario): ?>
                <tr>
                    <td><?php echo $inventario['idproductos']; ?></td>
                    <td><?php echo $inventario['pro_nombre']; ?></td>
                    <td><?php echo $inventario['pro_stock']; ?></td>
                </tr>
            <?php endforeach; ?>
        </table>
