...
//funcion para transferir del buscador proveedor al formulario y cerrar el buscador del proveedor
function transferirProveedor(id, nombre, ruc, telefono){
    document.getElementById('codigoprov').value = id;
    document.getElementById('nombre').value = nombre;
    document.getElementById('ruc').value = ruc;
    document.getElementById('telefono').value = telefono;
    document.getElementById('mimodalprov').style.display = 'none';
}
...
function cerrarModalYRecargar() {
    ...
    window.location.href = 'compfacturavista.php';
}

function cerrarModalYRedirigir() {
    cerrarModalmens('mimodalmens-err');
    window.location.href = 'facturacompravista.php';
}
